...
class NoteModel
{
    ...
    public static function getAllNotes()
    {
        ...
        $sql = "SELECT user_id, note_id, note_text, date_add, time_add FROM notes WHERE user_id = :user_id";
    ...
    public static function getNote($note_id)
    {
        ...
        $sql = "SELECT user_id, note_id, note_text, date_add, time_add FROM notes WHERE user_id = :user_id AND note_id = :note_id LIMIT 1";
        $query = $database->prepare($sql);
    ...
    public static function createNote($note_text)
    {
        ...
        $sql = "INSERT INTO notes (note_text, date_add, time_add, user_id) VALUES (:note_text, :user_id)";
        $query = $database->prepare($sql);
